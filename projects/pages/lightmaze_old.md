...
![Lightmaze 2](./media/lightmaze_old/2.png)

Pick up items to grow your light.

![Lightmaze 3](./media/lightmaze_old/3.png)

More light reveals more of the maze around you.

![Lightmaze 4](./media/lightmaze_old/4.png)

Bleach tiles to mark your path. Find a way to the exit tile! 

![Lightmaze 5](./media/lightmaze_old/5.png)

![Lightmaze 6](./media/lightmaze_old/6.png)
