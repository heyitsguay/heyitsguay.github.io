...
function initGLVars()
{
    ...
    uniformValues = {
        ...
        u_cdiff: {data: 0.01, type: gl.FLOAT},
        u_cdecay: {data: 0.9921875, type: gl.FLOAT},
        u_heatH: {data: 0.00, type: gl.FLOAT},
        u_Hgate: {data: 0.04098, type: gl.FLOAT},
        u_Sgate: {data: 0.0, type: gl.FLOAT},
